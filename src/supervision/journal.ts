...
export function newSupervision():SupervisionProjection {
  return{version:1,rounds:0,stalledRounds:0,phase:'ready',evidenceIds:[],evidenceHash:null,reviewedHash:null,completedTasks:0,forceReview:false,active:null,draft:null,decision:null,decisionId:null,halt:null,strategies:Object.create(null)};
}
...
export function validateSupervisionChange(value:unknown,plan:ProjectPlan):SupervisionChange {
  ...
  shape(value,['type'],['round','role','agentId','sessionId','evidenceIds','evidenceHash','decision','decisionId','receipts','outcome','reason','source']);
...
export function replaySupervisionChange(event:ExecutionEvent,plan:ProjectPlan,state:ExecutionProjection,prior:ExecutionEvent[],createdAt:number):void {
