...
const EXPECTED_COMMANDS = [
  '/help', '/status', '/doctor', '/permissions', '/tools', '/orchestrate', '/brain', '/kg', '/improve', '/run', '/agents', '/tasks', '/clear', '/exit', '/quit',
...
const EXPECTED_COMPLETION_ROOTS = [
  '/help', '/status', '/doctor', '/permissions', '/tools', '/orchestrate', '/brain', '/kg', '/improve', '/run', '/agents', '/tasks', '/clear', '/exit',
  '/model', '/provider', '/mode', '/defaults', '/once',
  '/undo', '/export', '/import', '/branch', '/checkout', '/diff', '/replay', '/resume', '/new', '/sessions', '/compact',
  '/scope', '/memory', '/trust', '/restore',
  '/mcp', '/skills',
